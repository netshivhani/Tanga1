...
<title>BIDWIN CONSTRUCTION BUILDING AND CIVIL</title>
<!--Bootstrap-->
    ...
    <div class="container">
      <div class="container-fluid">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#menu"><img src="images/Logo/02.png" alt=""></a> </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            ...
            <li><a class="scroll" href="#portfolio">Galleries</a></li>
            <!--<li><a class="scroll" href="#pricing">Pricing</a></li>-->
            <!--<li><a class="scroll" href="#team">Team</a></li>-->
            <li><a class="scroll" href="#blog">Clients</a></li>
        ...
        <div class="carousel-caption container">
          <div class="row">
            <div class="col-md-7 col-sm-12 col-xs-12">
              ...
              <p>Bidwin is a 100% black owned enti ty, operati ng within the borders of 
				 South Africa. As a company we off er reasonable and exclusive service to our 
				 customers at a market related pricing and we plan to take the market by storm 
				 to put ourselves on the map. We are eager to elevate our company to become 
				 one of the leading constructi on companies in our country and beyond. This 
				 cannot be achieved without us sti cking to our key values which we use as a 
  ...
  <div class="container">
    <div class="col-md-8 col-md-offset-2">
      <div class="heading">
        ...
        <div class="line"></div>
		<h3 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms"><span>V</span>ision</h3>
        <p><h6><span><strong>B</strong></span>idwin vision is to become one of the best few leaders in constructi on
		 industry in South Africa.</h6></p>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12 ab-sec">
        <div class="col-md-6">
          <h3 class="wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms"><span>O</span>ur Mission</h3>
          <p><span><strong>W</strong></span>e will provide leadership in identi fying needs and opportuniti es and 
		   harnessing the resources to encourage and assist business growth and 
		   development. We will make a diff erence by becoming the reasonable service 
		   provider in the constructi on industry. Becoming the best leader in constructi on 
		   and other services business. Giving our clients a lifelong deliverables to ensure 
		   future business and consistency. Strongly penetrati ng into informal and 
		   formal markets.
		 </p>
        </div>
		<div class="col-md-10 col-sm-10 col-xs-8">
			<h3>Vision</h3>
				<p><span><strong>B</strong></span>idwin vision is to become one of the best few leaders in constructi on
...
<div class="bg-sec">
  <div class="container">
    ...
    <!--<div class="col-md-2 col-sm-2 col-xs-4"> <a class="btn-down" href="#">BIDWIN</a> </div>-->
  </div>
</div>
  ...
  <div class="container">
    <div class="col-md-8 col-md-offset-2">
      <div class="heading">
        <h2>OUR SERVICE</h2>
        <div class="line"></div>
        <p><span><strong><h5>We at Bidwin provide the below services and many more</h5></strong></span></p>
      </div>
    </div>
    <div class="row">
      <div class="features-sec">
        <div class="col-md-4 col-sm-6 col-xs-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="300ms">
          <div class="media service-box">
            ...
            <div class="media-body">
              <h5 class="media-heading">Road Construction</h5>
              <p>We construct new and extend existing roads, we do roads maitenance and road patches</p>
            </div>
          </div>
        </div>
        <!--/.col-md-4-->
        <div class="col-md-4 col-sm-6 col-xs-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="300ms">
          <div class="media service-box">
            ...
            <div class="media-body">
              <h5 class="media-heading">Earthworks and Drainage</h5>
              <p>we provide earth moving and construction of sewage, drainage and many more</p>
            </div>
          </div>
        </div>
        <!--/.col-md-4-->
        <div class="col-md-4 col-sm-6 col-xs-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="300ms">
          <div class="media service-box">
            ...
            <div class="media-body">
              <h5 class="media-heading">General Building maintenance</h5>
              <p>This includes building houses,Roofing, painting and Paving Township development.</p>
            </div>
          </div>
        </div>
        <!--/.col-md-4-->
        <div class="col-md-4 col-sm-6 col-xs-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="300ms">
          <div class="media service-box">
            ...
            <div class="media-body">
              <h5 class="media-heading">Electrical/Mechanical maintenance</h5>
              <p>We at Bidwin offer electrical engineering and adhoc maintainance of electrical needs</p>
            </div>
          </div>
        </div>
        <!--/.col-md-4-->
        <div class="col-md-4 col-sm-6 col-xs-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="300ms">
          <div class="media service-box">
            ...
            <div class="media-body">
              <h5 class="media-heading">Paving</h5>
              <p>We do tar road and paving for commercial and residential</p>
            </div>
          </div>
        </div>
        <!--/.col-md-4-->
        <div class="col-md-4 col-sm-6 col-xs-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="300ms">
          <div class="media service-box">
            ...
            <div class="media-body">
              <h5 class="media-heading">Supply and delivery supplier of mining and industrial spares</h5>
              <p>We deliver and supply all your mining spares and chemical and Uniforms(clothing)</p>
            </div>
          </div>
        </div>
		<div class="col-md-4 col-sm-6 col-xs-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="300ms">
          <div class="media service-box">
            <div class="pull-left"> <i class="fa fa-bullseye"></i> </div>
            <div class="media-body">
              <h5 class="media-heading">Cleaning Services</h5>
              <p>We provide personel and cleaning services to all industries.</p>
            </div>
          </div>
        </div>
        <!--/.col-md-4-->
...
<section id="portfolio">
  <div class="container">
    <div class="col-md-8 col-md-offset-2">
      <div class="heading">
        <h2>GALLERI<span>ES</span></h2>
        <div class="line"></div>
        <p><span><strong>O</strong></span>ur Works</p>
      </div>
    </div>
    <div class="text-center">
      <ul class="portfolio-filter">
        ...
        <li><a href="#" data-filter=".portfolio">Industrial</a></li>
      </ul>
      <!--/#portfolio-filter-->
    </div>
...
<section id="blog">
  <div class="container">
    <div class="col-md-8 col-md-offset-2">
      <div class="heading">
        <h2>OUR CLIEN<span>TS</span></h2>
        <div class="line"></div>
        <p><span><strong><h6>Tenders and projects delivery with most of our clients</h6></strong></span></p>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
        <div class="col-md-4 blog-sec">
          <div class="blog-info"> <img src="images/Blog/1.jpg" class="img-responsive" alt="">
            <div class="data-meta">
              ...
              2016 </div>
            <a href="#">
            <h5>Harmony Gold Mining</h5>
            </a>
            <ul class="blog-icon">
              <li><a href="#">
                <h6>Building Maintenance</h6>
                </a></li>              
            </ul>
            <p>Building, construction,Maitenance and Repair of commercial structure, paint, plaster, floors and sanitory</p>
        ...
        <div class="col-md-4 blog-sec">
          <div class="blog-info"> <img src="images/Blog/2.jpg" class="img-responsive" alt="">
            ...
            <p>Construction of new sewer and roads in district</p>
            <a href="#" class="btn-blg">Read More</a> </div>
        </div>
        <div class="col-md-4 blog-sec">
          <div class="blog-info"> <img src="images/Blog/3.jpg" class="img-responsive" alt="">
            <div class="data-meta">
              ...
              2015 </div>
            <a href="#">
            <h5>Transnet Freight Rail</h5>
            </a>
            <ul class="blog-icon">
              <li><a href="#">
                <h6>Project and services</h6>
                </a></li>              
            </ul>
            <p>Providing services and project delivery</p>
            <a href="#" class="btn-blg">Read More</a> </div>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="col-md-8 col-md-offset-2">
      <div class="heading">
        ...
        <div class="line"></div>
        <p><span><strong>W</strong></span>e at BIDWIN would like to here from you, Please reach us by using any resources provided below and also on our social media at the bottom of our WEBSITE</p>
      </div>
    </div>
    <div class="text-center">
      <div class="col-md-6 col-sm-6 contact-sec-1">
        ...
        <ul class="contact-form">
          <li><i class="fa fa-map-marker"></i>
            <h6><strong>Address:</strong> 31 Leopard Street, Amajuba Park, Newcastle, 2940 </h6>
			<h6><strong>Fax:</strong> 086 690-6054 </h6>
          </li>
          <li><i class="fa fa-envelope"></i>
            <h6><strong>Mail Us:</strong> <a href="#"> bidwin@vodamail.co.za </a></h6>
          </li>
          <li><i class="fa fa-phone"></i>
            <h6><strong>Phone:</strong>  +27 11 862-1066 </h6>
          </li>
          <li><i class="fa fa-wechat"></i>
            <h6><strong>Website:</strong> <a href="#">www.bidwin.co.za</a> </h6>
          </li>
        </ul>
      </div>
...
<footer id="footer-down">
  ...
  <p>© Copyright
  <script>document.write( new Date().getFullYear() );</script> All right are reserved
  </p>
  </br>
  </br>
  <p>website created and maitained by: <a href="#"><i style="color:#00BFFF;">NtangaITSolutions</i></a></p>
  <br/>
  <p><a class="scroll" style="color:red;" href="#menu">scroll to the top</a> </p>
</footer>
<!--Jquery-->
